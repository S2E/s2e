...
static bool forward_field_translate_name(ForwardFieldVisitor *v, const char **name, Error **errp) {
    if (v->depth) {
        return true;
    }
...
static bool forward_field_start_struct(Visitor *v, const char *name, void **obj, size_t size, Error **errp) {
    ForwardFieldVisitor *ffv = to_ffv(v);
...
static bool forward_field_start_list(Visitor *v, const char *name, GenericList **list, size_t size, Error **errp) {
    ForwardFieldVisitor *ffv = to_ffv(v);
...
static GenericList *forward_field_next_list(Visitor *v, GenericList *tail, size_t size) {
    ForwardFieldVisitor *ffv = to_ffv(v);
...
static bool forward_field_start_alternate(Visitor *v, const char *name, GenericAlternate **obj, size_t size,
                                          Error **errp) {
    ForwardFieldVisitor *ffv = to_ffv(v);
...
static bool forward_field_type_int64(Visitor *v, const char *name, int64_t *obj, Error **errp) {
    ForwardFieldVisitor *ffv = to_ffv(v);
...
static bool forward_field_type_uint64(Visitor *v, const char *name, uint64_t *obj, Error **errp) {
    ForwardFieldVisitor *ffv = to_ffv(v);
...
static bool forward_field_type_bool(Visitor *v, const char *name, bool *obj, Error **errp) {
    ForwardFieldVisitor *ffv = to_ffv(v);
...
static bool forward_field_type_str(Visitor *v, const char *name, char **obj, Error **errp) {
    ForwardFieldVisitor *ffv = to_ffv(v);
...
static bool forward_field_type_size(Visitor *v, const char *name, uint64_t *obj, Error **errp) {
    ForwardFieldVisitor *ffv = to_ffv(v);
...
static bool forward_field_type_number(Visitor *v, const char *name, double *obj, Error **errp) {
    ForwardFieldVisitor *ffv = to_ffv(v);
...
static bool forward_field_type_any(Visitor *v, const char *name, QObject **obj, Error **errp) {
    ForwardFieldVisitor *ffv = to_ffv(v);
...
static bool forward_field_type_null(Visitor *v, const char *name, QNull **obj, Error **errp) {
    ForwardFieldVisitor *ffv = to_ffv(v);
...
static bool forward_field_policy_reject(Visitor *v, const char *name, unsigned special_features, Error **errp) {
    ForwardFieldVisitor *ffv = to_ffv(v);
...
static bool forward_field_policy_skip(Visitor *v, const char *name, unsigned special_features) {
    ForwardFieldVisitor *ffv = to_ffv(v);
