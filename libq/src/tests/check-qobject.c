...
#define check_equal(...)   do_test_equality(true, 0, __VA_ARGS__, &test_equality_end_of_arguments)
#define check_unequal(...) do_test_equality(false, 0, __VA_ARGS__, &test_equality_end_of_arguments)
...
static void qobject_is_equal_string_test(void) {
    ...
    check_unequal(str_base, str_whitespace_0, str_whitespace_1, str_whitespace_2, str_whitespace_3, str_case);
...
static void qobject_is_equal_dict_test(void) {
    ...
    check_unequal(dict_0, dict_different_key, dict_different_value, dict_different_null_key, dict_longer, dict_shorter,
                  dict_nested);
...
int main(int argc, char **argv) {
    ...
    g_test_add_func("/public/qobject_is_equal_null", qobject_is_equal_null_test);
    g_test_add_func("/public/qobject_is_equal_num", qobject_is_equal_num_test);
    g_test_add_func("/public/qobject_is_equal_bool", qobject_is_equal_bool_test);
    g_test_add_func("/public/qobject_is_equal_string", qobject_is_equal_string_test);
    g_test_add_func("/public/qobject_is_equal_list", qobject_is_equal_list_test);
    g_test_add_func("/public/qobject_is_equal_dict", qobject_is_equal_dict_test);
    g_test_add_func("/public/qobject_is_equal_conversion", qobject_is_equal_conversion_test);
