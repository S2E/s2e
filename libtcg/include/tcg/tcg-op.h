...
static inline void tcg_gen_qemu_ld_i32(TCGv_i32 v, TCGv a, TCGArg i, MemOp m) {
    tcg_gen_qemu_ld_i32_chk(v, tcgv_tl_temp(a), i, m, TCG_TYPE_TL);
}

static inline void tcg_gen_qemu_st_i32(TCGv_i32 v, TCGv a, TCGArg i, MemOp m) {
    tcg_gen_qemu_st_i32_chk(v, tcgv_tl_temp(a), i, m, TCG_TYPE_TL);
}

static inline void tcg_gen_qemu_ld_i64(TCGv_i64 v, TCGv a, TCGArg i, MemOp m) {
    tcg_gen_qemu_ld_i64_chk(v, tcgv_tl_temp(a), i, m, TCG_TYPE_TL);
}

static inline void tcg_gen_qemu_st_i64(TCGv_i64 v, TCGv a, TCGArg i, MemOp m) {
    tcg_gen_qemu_st_i64_chk(v, tcgv_tl_temp(a), i, m, TCG_TYPE_TL);
}

static inline void tcg_gen_qemu_ld_i128(TCGv_i128 v, TCGv a, TCGArg i, MemOp m) {
    tcg_gen_qemu_ld_i128_chk(v, tcgv_tl_temp(a), i, m, TCG_TYPE_TL);
}

static inline void tcg_gen_qemu_st_i128(TCGv_i128 v, TCGv a, TCGArg i, MemOp m) {
...
#define DEF_ATOMIC2(N, S)                                                           \
    static inline void N##_##S(TCGv_##S r, TCGv a, TCGv_##S v, TCGArg i, MemOp m) { \
        N##_##S##_chk(r, tcgv_tl_temp(a), v, i, m, TCG_TYPE_TL);                    \
    }

#define DEF_ATOMIC3(N, S)                                                                       \
    static inline void N##_##S(TCGv_##S r, TCGv a, TCGv_##S o, TCGv_##S n, TCGArg i, MemOp m) { \
...
#define dup_const_tl(VECE, C)                                                                \
    (__builtin_constant_p(VECE) ? ((VECE) == MO_8    ? 0x01010101ul * (uint8_t) (C)          \
