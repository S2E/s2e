...
void perf_report_code(uint64_t guest_pc, TranslationBlock *tb, const void *start);
...
static inline void perf_report_code(uint64_t guest_pc, TranslationBlock *tb, const void *start) {
}
