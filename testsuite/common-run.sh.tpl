...
check_coverage() {
    ...
    s2e coverage $EXTRA_PARAMS lcov --exclude-pattern /usr/share/mingw-w64/include/ --exclude-pattern /usr/x86_64-w64-mingw32 --exclude-pattern /usr/i686-w64-mingw32 --exclude-pattern guest/common/include/s2e/ --html {{ project_name }} | tee $S2E_LAST/cov.log
