...
#define DEF_HELPER_0_M(name, ret, rm, wm, m) DEF_HELPER_FLAGS_0_M(name, 0, ret, rm, wm, m)
#define DEF_HELPER_1_M(name, ret, t1, rm, wm, m) DEF_HELPER_FLAGS_1_M(name, 0, ret, t1, rm, wm, m)
#define DEF_HELPER_2_M(name, ret, t1, t2, rm, wm, m) DEF_HELPER_FLAGS_2_M(name, 0, ret, t1, t2, rm, wm, m)
#define DEF_HELPER_3_M(name, ret, t1, t2, t3, rm, wm, m) DEF_HELPER_FLAGS_3_M(name, 0, ret, t1, t2, t3, rm, wm, m)
#define DEF_HELPER_4_M(name, ret, t1, t2, t3, t4, rm, wm, m) \
    DEF_HELPER_FLAGS_4_M(name, 0, ret, t1, t2, t3, t4, rm, wm, m)

#define DEF_HELPER_0(name, ret) DEF_HELPER_0_M(name, ret, (uint64_t) -1, (uint64_t) -1, 1)
#define DEF_HELPER_1(name, ret, t1) DEF_HELPER_1_M(name, ret, t1, (uint64_t) -1, (uint64_t) -1, 1)
#define DEF_HELPER_2(name, ret, t1, t2) DEF_HELPER_2_M(name, ret, t1, t2, (uint64_t) -1, (uint64_t) -1, 1)
#define DEF_HELPER_3(name, ret, t1, t2, t3) DEF_HELPER_3_M(name, ret, t1, t2, t3, (uint64_t) -1, (uint64_t) -1, 1)
#define DEF_HELPER_4(name, ret, t1, t2, t3, t4) \
    DEF_HELPER_4_M(name, ret, t1, t2, t3, t4, (uint64_t) -1, (uint64_t) -1, 1)

#define DEF_HELPER_FLAGS_0(name, flags, ret) DEF_HELPER_FLAGS_0_M(name, flags, ret, (uint64_t) -1, (uint64_t) -1, 1)
...
#define DEF_HELPER_FLAGS_0_M(name, flags, ret, rm, wm, m) dh_ctype(ret) HELPER(name)(void);

#define DEF_HELPER_FLAGS_1_M(name, flags, ret, t1, rm, wm, m) dh_ctype(ret) HELPER(name)(dh_ctype(t1));
...
#define DEF_HELPER_FLAGS_1_M(name, flags, ret, t1, rm, wm, m) DEF_HELPER_FLAGS_0_M(name, flags, ret, rm, wm, m)

#define DEF_HELPER_FLAGS_2_M(name, flags, ret, t1, t2, rm, wm, m) DEF_HELPER_FLAGS_0_M(name, flags, ret, rm, wm, m)

#define DEF_HELPER_FLAGS_3_M(name, flags, ret, t1, t2, t3, rm, wm, m) DEF_HELPER_FLAGS_0_M(name, flags, ret, rm, wm, m)
